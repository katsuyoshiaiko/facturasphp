...
function logo($w = null, $h = null, $class = null) {
    ...
    if (isset($config_company_logo) && file_exists("./www/gallery/img/logos/$config_company_logo")) {
        if ($w) {
            echo '<img src="./www/gallery/img/logos/' . $config_company_logo . '" alt="" width="' . $w . '" class="' . $class . '"/>';
        } else {
            echo '<img src="./www/gallery/img/logos/' . $config_company_logo . '" alt="" class="' . $class . '"/>';
        }
    } else {
        echo '<img src="www/gallery/img/logos/factux.jpg" width="' . $w . '" alt=""/>';
    }
}
...
function logo_img() {
    ...
    return "./www/gallery/img/logos/$config_company_logo";
}
...
/**
 * Verifica si una string es una fecha valida
 * @param type $date
 * @return type
 */
...
//    //$url = $url . "&pag=$lastPage";
//    echo '<p>$totalItems : ' . $totalItems . '</p>'; 
//    echo '<p>$itemsByPage : ' . $itemsByPage . '</p>';     
//    echo '<p>$page : ' . $page . '</p>'; 
//    
//    echo '<p>$totalPages : ' . $totalPages . '</p>';     
//    
//    echo '<p>$lastPage : ' . $lastPage . '</p>'; 
//    echo '<p>$actualPage : ' . $actualPage . '</p>'; 
//    
//    
//        
    // pagination
