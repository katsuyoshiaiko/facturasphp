    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">
                <?php echo _t("Number") ; ?> : <?php echo $id ; ?>
            </a>
        </div>
...
<?php if( permissions_has_permission($u_rol , $c , "update") && budgets_can_be_edit($id)){ ?>
            <form class="navbar-form navbar-right">
                ...
                <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> <?php _t("Edit budget") ; ?></button>
            </form>        
<?php } ?>
