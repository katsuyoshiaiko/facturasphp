...
//            $discounts_mode = ($cn['discounts_mode'] == '%') ? "$cn[discounts]$cn[discounts_mode]" : "" ;
            ...
            $this->Cell(($this->get_Pdf_ancho() / 100) * 10 , $this->get_Pdf_alto_linea() * 1 , $cn['quantity'] , 0 , 0 , 'L' , $color) ;
            //$this->Cell(($this->get_Pdf_ancho() / 100) * 80 , $this->get_Pdf_alto_linea() * 1 , $cn['description'] , 0 , 0 , "L" , $color) ;
            $this->Cell(($this->get_Pdf_ancho() / 100) * 80 , $this->get_Pdf_alto_linea() * 1 , '' , 0 , 0 , "L" , $color) ;
            ...
            $this->Cell(($this->get_Pdf_ancho() / 100) * 10 , $this->get_Pdf_alto_linea() * 1 , monedaf($cn['totaltaxc'] ) , 0 , 1 , 'R' , $color) ;
...
//// MULTI CELDA
        ...
        $this->Cell($this->get_Pdf_ancho() / 2 , $this->get_Pdf_alto_linea() * 3 , monedaf($credit_notes['total'] + $credit_notes['tax']) , "TB" , 1 , 'R' , 0) ;
