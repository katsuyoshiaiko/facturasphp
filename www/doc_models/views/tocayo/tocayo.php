...
class TOCAYO extends FPDF {
    ...
    function bodyDate($document) {
        ...
        $date = 
                ...
                $document['date'] 
                :  
                substr($document['date_registre'], 0, 10);
        ...
        $this->Cell($this->get_Pdf_ancho() / 4, $this->get_Pdf_alto_linea() * 1, "", "", 0, 'L', 0);
        $this->Cell($this->get_Pdf_ancho() / 4, $this->get_Pdf_alto_linea() * 1, _trc("Id"), "", 1, 'R', 0);

        $this->SetFont('Arial', '', 10);
        $this->Cell($this->get_Pdf_ancho() / 4, $this->get_Pdf_alto_linea() * 1, $date, "", 0, 'L', 0);
        $this->Cell($this->get_Pdf_ancho() / 4, $this->get_Pdf_alto_linea() * 1, "", "", 0, 'L', 0);
        $this->Cell($this->get_Pdf_ancho() / 4, $this->get_Pdf_alto_linea() * 1, "", "", 0, 'L', 0);
        $this->Cell($this->get_Pdf_ancho() / 4, $this->get_Pdf_alto_linea() * 1, $document['id'], "", 1, 'R', 0);
    ...
    function encabezados() {
        ...
        $this->Cell(($this->get_Pdf_ancho() / 100) * 15 , $this->get_Pdf_alto_linea() * 1 , _trc("Qty")         , 'T' , 0 , 'L' , 1) ;
#     $this->Cell(($this->get_Pdf_ancho() / 100) * 7 , $this->get_Pdf_alto_linea() * 1 , _trc("Code")         , 'T' , 0 , 'L' , 1) ;
        $this->Cell(($this->get_Pdf_ancho() / 100) * 31 , $this->get_Pdf_alto_linea() * 1 , _trc("Description") , 'T' , 0 , 'C' , 1) ;
        $this->Cell(($this->get_Pdf_ancho() / 100) * 9 , $this->get_Pdf_alto_linea() * 1 , _trc("Price")       , 'T' , 0,  'R' , 1) ;
        $this->Cell(($this->get_Pdf_ancho() / 100) * 9 , $this->get_Pdf_alto_linea() * 1 , _trc("Sub total")   , 'T' , 0,  'R' , 1) ;
        $this->Cell(($this->get_Pdf_ancho() / 100) * 9 , $this->get_Pdf_alto_linea() * 1 , _trc("Discount")    , 'T' , 0,  'R' , 1) ;
        $this->Cell(($this->get_Pdf_ancho() / 100) * 9 , $this->get_Pdf_alto_linea() * 1 , _trc("HTVA")        , 'T' , 0,  'R' , 1) ;
        $this->Cell(($this->get_Pdf_ancho() / 100) * 9 , $this->get_Pdf_alto_linea() * 1 , _trc("TVA")         , 'T' , 0,  'R' , 1) ;
        $this->Cell(($this->get_Pdf_ancho() / 100) * 9 , $this->get_Pdf_alto_linea() * 1 , _trc("TVAC")        , 'T' , 1,  'R' , 1) ;
        $this->SetFont('Arial' , '' , 8) ;
    ...
    function payements_conditions($invoices){
        ...
        $tvac = ($invoices['total'] + $invoices['tax']) - $invoices['advance']; 
    ...
    function communication($invoices){
        ...
        $this->Cell(
                $this->get_Pdf_ancho() , 
                $this->get_Pdf_alto_linea() , 
                (_trc("Communication")) . ": " . $invoices['ce']   , 
                1 , 
                0 , 
                'C', 
                1) ;
