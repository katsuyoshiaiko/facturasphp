            ...
            <tbody>
                <tr>
                    ...
                    foreach ($expense_lines as $expense_lines) {
                        ...
                        echo "<td class=\"text-right\">$expense_lines[price] EUR</td>";
                        echo "<td class=\"text-right\">$expense_lines[discounts] %</td>";
                        echo "<td class=\"text-right\">$expense_lines[tax] EUR</td>";
