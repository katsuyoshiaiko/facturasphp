<?php
//vardump(budgets_not_expensed_by_company_id(expenses_field_id("client_id" , $id) , 30));

if ( ! budgets_not_expensed_by_company_id(expenses_field_id("client_id" , $id) , 30) ) {
    ...
    <table class="table table-striped">
        ...
        <form action="index.php" method="post" class="form-inline">                                                                                                                              
            ...
            <?php
            $totalGeneral = 0 ;
            foreach ( budgets_not_expensed_by_company_id(expenses_field_id("client_id" , $id) , 30) as $key => $budget ) {
