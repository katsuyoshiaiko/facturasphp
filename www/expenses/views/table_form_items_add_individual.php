<form action="index.php" method="post" class="form-inline">                                                                                              
    ...
    <tr>
        ...
        <td>
            <div class="row">
                <div class="col-xs-6">
                    <input type="text" name="quantity" class="form-control" placeholder="<?php _t("Quantity"); ?>">
                </div>
            </div>
        </td>
        <td>
            <div class="row">
                <div class="col-xs-12">
                    <input type="text" name="description" class="form-control" placeholder="<?php _t("Description"); ?>" autofocus="">
                </div>
            </div>
        </td>
