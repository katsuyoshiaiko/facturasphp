...
class Gallery {
    ...
    private $_path = "www_extended/default/gallery/img/" ; //al final con /
    ...
    public function sendFile($newName) {
        ...
        if ( ! $this->checkFileType() ) {
            array_push($this->_errors , "File extension not acepted") ;
        }
    ...
    public function sendFileNotChangeName() {
        $this->_formatedName = $this->_name ;

        if ( ! $this->checkFileType() ) {
            array_push($this->_errors , "File extension not acepted") ;
            array_push($this->_errors  , $this->_type ); 
        }
    ...
    public function changeName($newName) {
        ...
        switch ( $this->_type ) {
            ...
            case "image/jpeg":
                $this->_formatedName = $newName . ".jpeg" ;
                return true ;
                break ;
    ...
    public function checkDownloadCorrectly() {
        return ( file_exists($this->_path . $this->_formatedName) ) ? 
                ($this->_path . $this->_formatedName)
                : false ;
    }
