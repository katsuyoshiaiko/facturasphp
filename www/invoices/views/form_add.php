...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <?php # date_expiration ?>
    <div class="form-group">
        <label class="control-label col-sm-2" for="date_expiration"><?php _t("Expiration date"); ?></label>
        <div class="col-sm-8">
            <input 
                type="text"  
            ...
            <span class="help-block" >
                ...
                - 
                <a href="index.php?c=config&a=invoices_expiration_days"><?php _t("change here");  ?> <span class="glyphicon glyphicon-wrench"></span></a>
            </span>
