<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input 
                ...
                id="total" 
                placeholder=""
                value="<?php echo invoices_field_id("total" , $id) + invoices_field_id("tax" , $id) - invoices_field_id("advance" , $id) ?>"
                >
        </div>	
    </div>
    <?php # /total ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number"  name="ref" class="form-control" id="ref" placeholder="<?php _t("Operation number"); ?>" required="">
