...
<?php # author ?>
     <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text"  name="author" class="form-control" id="author" placeholder=" - defecto">
       </div>	
    </div>
<?php # /author ?>
...
<?php # author_email ?>
     <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text"  name="author_email" class="form-control" id="author_email" placeholder=" - defecto">
       </div>	
    </div>
<?php # /author_email ?>
