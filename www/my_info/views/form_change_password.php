<form class="form-horizontal" method="post" action="index.php" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="password" name="ap" class="form-control" id="actual" placeholder="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="text" name="np" class="form-control" id="new" placeholder="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="text" name="rp" class="form-control" id="repete" placeholder="">
        </div>
    </div>
