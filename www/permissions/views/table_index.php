...
?>
        ...
        <tr>
            ...
            foreach ( $permissions as $permissions_item ) {
                ...
                $c = ($permissions_item['crud'][0]) ? '<span class="label label-primary">' . _tr('Create') . '</span>' : '<span class="label label-default">' . _tr('Create') . '</span>' ;
                $r = ($permissions_item['crud'][1]) ? '<span class="label label-primary">' . _tr('Read') . '</span>' : '<span class="label label-default">' . _tr('Read') . '</span>' ;
                $u = ($permissions_item['crud'][2]) ? '<span class="label label-primary">' . _tr('Update') . '</span>' : '<span class="label label-default">' . _tr('Update') . '</span>' ;
                $d = ($permissions_item['crud'][3]) ? '<span class="label label-primary">' . _tr('Delete') . '</span>' : '<span class="label label-default">' . _tr('Delete') . '</span>' ;
                ?>
