...
<?php # am_start ?>
     <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text"  name="am_start" class="form-control" id="am_start" placeholder=" - defecto">
       </div>	
    </div>
<?php # /am_start ?>
...
<?php # am_end ?>
     <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text"  name="am_end" class="form-control" id="am_end" placeholder=" - defecto">
       </div>	
    </div>
<?php # /am_end ?>
...
<?php # pm_start ?>
     <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text"  name="pm_start" class="form-control" id="pm_start" placeholder=" - defecto">
       </div>	
    </div>
<?php # /pm_start ?>
...
<?php # pm_end ?>
     <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text"  name="pm_end" class="form-control" id="pm_end" placeholder=" - defecto">
       </div>	
    </div>
<?php # /pm_end ?>
