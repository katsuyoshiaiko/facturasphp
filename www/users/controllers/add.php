...
if (!users_is_name(($name)))        {array_push($error, "Name error");}
if (!users_is_lastname($lastname))  {array_push($error, "Lastname error");}
if (!users_is_address($address))    {array_push($error, "Address error");}
if (!users_is_postcode($postcode))  {array_push($error, "Postcode error");}
if (!users_is_title($title))        {array_push($error, "Title error");}
if (!users_is_birthdate($birthdate)){array_push($error, "Birthdate error");}
if (!users_is_login($login))        {array_push($error, "Login error");}
if (!users_is_password($password))  {array_push($error, "Password error");}
if (!users_is_email($email))        {array_push($error, "Email error");}
if (!users_is_status($status))      {array_push($error, "Status error");}
